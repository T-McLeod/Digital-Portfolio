...
const SkillCard: React.FC<{ skill: Skill }> = ({ skill }) => (
  <div className="flex flex-col items-center justify-center p-6 bg-slate-800 rounded-lg shadow-lg hover:shadow-sky-500/20 transition-all duration-300 transform hover:-translate-y-2">
    <div className="h-8 w-8 text-sky-400" dangerouslySetInnerHTML={{ __html: skill.svg_icon }} />
      ...
      try {
        ...
        setError(
            <div className="text-center text-red-300 bg-slate-800 p-6 rounded-lg shadow-lg">
                ...
                <p className="mb-4">Failed to load skills. Please ensure the backend server is running.</p>
